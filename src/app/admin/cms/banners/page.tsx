...
export default function AdminBannersPage() {
  ...
  const { data: banners = [], isLoading } = useBanners(locale.localeId);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <PageHeader
          title="Banners"
          description={`Time-bound promotional banners for ${locale.localeId}`}
        />
      ...
      {banners.length === 0 ? (
        <div className="rounded-lg border border-dashed p-12 text-center">
          ...
          <p className="text-muted-foreground">No banners for {locale.localeId}.</p>
          <PermissionGate permission={PERMISSIONS.CMS_MANAGE_BANNERS}>
