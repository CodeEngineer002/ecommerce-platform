...
export default function AdminNavigationPage() {
  ...
  const { data: menus = [], isLoading } = useNavigationMenus(locale.localeId);
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <PageHeader
          ...
          description={`Locale-aware menus for ${locale.localeId}`}
        />
      ...
      {menus.length === 0 ? (
        <div className="rounded-lg border border-dashed p-12 text-center">
          ...
          <p className="text-muted-foreground">No navigation menus for {locale.localeId}.</p>
          <PermissionGate permission={PERMISSIONS.CMS_MANAGE_NAVIGATION}>
